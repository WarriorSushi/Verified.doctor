...
const getProfileByHandle = cache(async (handle: string) => {
  ...
  const { data: profile, error } = await supabase
    ...
    .select(`
      ...
      years_experience, registration_number, clinic_name, clinic_location,
      languages, consultation_fee, services, profile_photo_url,
      external_booking_url, is_verified, recommendation_count, connection_count,
      profile_template, profile_layout, profile_theme, is_frozen,
