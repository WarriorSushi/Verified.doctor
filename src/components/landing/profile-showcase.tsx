...
const SAMPLE_DOCTORS = [
  {
    ...
    handle: "asra",
    full_name: "Dr. Asra",
    specialty: "Pediatrician & Neonatologist Fellow",
    qualifications: "MBBS, MD (Pediatrics), Fellowship in Neonatology",
    years_experience: 5,
    clinic_name: "Yashoda Hospital",
    clinic_location: "Hyderabad",
    profile_photo_url: "/doctors/doctor-1.webp",
    bio: "Passionate pediatrician with a deep commitment to newborn and child health. Currently pursuing Fellowship in Neonatology at Yashoda Hospital, specializing in critical care of preterm and high-risk neonates.",
    recommendation_count: 89,
    connection_count: 42,
    is_verified: true,
    layout: "classic",
    theme: "blue",
    services: ["Newborn Care", "NICU Management", "Vaccination", "Growth Monitoring", "Developmental Assessment", "Breastfeeding Counseling"],
    // New fields
    education_timeline: [
      { institution: "Al Ameen Medical College, Bijapur", degree: "MBBS", year: "2018" },
      { institution: "Al Ameen Medical College, Bijapur", degree: "MD (Pediatrics)", year: "2022" },
      { institution: "Yashoda Hospital, Hyderabad", degree: "Fellowship in Neonatology", year: "2025" },
    ],
    hospital_affiliations: [
      { name: "Yashoda Hospital", role: "Neonatology Fellow", department: "NICU" },
    ],
    conditions_treated: "Preterm Birth Complications, Neonatal Jaundice, Respiratory Distress Syndrome, Low Birth Weight, Childhood Infections, Growth Disorders",
    procedures_performed: "Neonatal Resuscitation, CPAP Ventilation, Surfactant Therapy, Exchange Transfusion, Umbilical Catheterization",
    approach_to_care: "Every child deserves the best start in life. I combine evidence-based neonatal care with compassionate family-centered practice, ensuring parents are informed and involved at every step.",
    case_studies: [
      { title: "Extremely Preterm Neonate at 26 Weeks", description: "Successful management of a 780g preterm infant with respiratory distress syndrome", outcome: "Healthy discharge at 38 weeks corrected age with normal developmental milestones" },
    ],
    first_visit_guide: "Please bring your child's birth records, vaccination card, and any previous medical reports. For newborns, bring the mother's pregnancy and delivery records as well.",
    is_available: true,
    availability_note: "Accepting new patients",
    offers_telemedicine: true,
    professional_memberships: [
      { organization: "Indian Academy of Pediatrics", year: "2022" },
      { organization: "National Neonatology Forum", year: "2023" },
    ],
    media_publications: [
      { title: "Neonatal Care Advances in India", publication: "Indian Pediatrics Journal", link: "#", year: "2024" },
    ],
  },
  {
    id: "2",
